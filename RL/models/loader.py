...
def crear_model(spec: dict[str, Any], env_config: dict[str, Any]) -> TrucModel | None:
    ...
    if tipus == "nfsp":
        from RL.models.adapters.rlcard_model import _crear_nfsp
        return _crear_nfsp(spec, env_config)

    if tipus == "dqn":
        from RL.models.adapters.rlcard_model import _crear_dqn
        return _crear_dqn(spec, env_config)
        
    if tipus == "numpy_dqn":
        from RL.models.numpy_agent import _crear_numpy_dqn
